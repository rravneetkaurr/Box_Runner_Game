...
public:
    ...
    // function to check if a position is a corner in the path
    ...
    // function to check if a position is adjacent to a corner in the path
    ...
    // function to check if a position already has an obstacle
    ...
    // function to check if a position is adjacent to another obstacle
    ...
    // generates path without obstacles
    void extendPath() {
        try {
            int x = maxX, z = maxZ;
...
int main(int argc, char** argv) {
    try {
        ...
        glutCreateWindow("3D Box Runner with Obstacles");
